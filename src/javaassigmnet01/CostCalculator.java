...
public class CostCalculator {
    ...
    public static double calculateFuelUsed(int distance, int fuelEfficiency) {
        // FuelUsed = D/E
        return distance / (double)fuelEfficiency;
    }
    ...
    public static double calculateDeliveryTime(int distance, int avgSpeed) {
        // Time = D/S
        return distance / (double)avgSpeed;
    }
